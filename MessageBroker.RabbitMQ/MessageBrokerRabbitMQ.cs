...
namespace Ate.MM.EventBus.RabbitMQ
{
    public class MessageBrokerRabbitMQ : MessageBrokerBase
    {
        RabbitMQPersistentConnection persistentConnection;
        private readonly IModel channel;
        private readonly string exchangeType = "Fanout";

        public MessageBrokerRabbitMQ(MessageBrokerConfiguration config, IServiceProvider serviceProvider) : base(config, serviceProvider)
        {
        ...
        public override void Publish(IntegrationEvent @event)
        {
            ...
            policy.Execute(() =>
            {
                ...
                #region Fanout exchange şeklinde publish edip her consumer kendi queue'sunu declare ederek bu exchange'e bind olmalı.
                ...
                //channel.QueueBind(queue: GetSubName(eventName), exchange: EventBusConfig.DefaultTopicName, routingKey: eventName); 
                #endregion
...
#region düz rabbit mq kodu example Publish methodu için
//if (!persistentConnection.IsConnected)
//{
//    persistentConnection.TryConnect();
//}
