...
using MessageBroker.Base.SubscriptionManagers;
...
namespace MessageBroker.Base.Events
{
    public abstract class MessageBrokerBase : IMessageBroker
    {
        ...
        public readonly IMessageBrokerSubscriptionManager SubscriptionManager;

        public MessageBrokerConfiguration EventBusConfig { get; set; }

        public MessageBrokerBase(MessageBrokerConfiguration config, IServiceProvider serviceProvider)
        {
        ...
        public abstract void Subscribe<T, TH>() where T : IntegrationEvent where TH : IEventHandler<T>;
        public abstract void Subscribe<T, TH>(string exchangeName) where T : IntegrationEvent where TH : IEventHandler<T>;
        public abstract void Subscribe<T, TH>(string exchangeName, string queueName) where T : IntegrationEvent where TH : IEventHandler<T>;

        public abstract void UnSubscribe<T, TH>() where T : IntegrationEvent where TH : IEventHandler<T>;
    }
}
